...
class Template(Base):
    ...
    id: Mapped[uuid.UUID] = _uuid_pk()
    company_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("doc_companies.id"), nullable=False)
    product_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("doc_products.id"), nullable=False)
    document_type_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("doc_document_types.id"), nullable=False)
...
class TemplateVersion(Base):
    ...
    id: Mapped[uuid.UUID] = _uuid_pk()
    template_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("doc_templates.id"), nullable=False)
...
class SchemaField(Base):
    ...
    id: Mapped[uuid.UUID] = _uuid_pk()
    schema_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("doc_document_schemas.id"), nullable=False)
...
class GeneratedDocumentVersion(Base):
    ...
    id: Mapped[uuid.UUID] = _uuid_pk()
    document_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("doc_generated_documents.id"), nullable=False)
    version: Mapped[int] = mapped_column(Integer, nullable=False, default=1)
    template_version_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("doc_template_versions.id"), nullable=False)
    schema_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("doc_document_schemas.id"), nullable=False)
