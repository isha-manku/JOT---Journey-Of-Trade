...
\VAR{labels.trial_container} & \VAR{trial_container} \\ \VAR{labels.price} & \VAR{trial_price} \\ \VAR{labels.trial_shipment_value} & \VAR{trial_shipment_value} \\ \VAR{labels.trial_quantity_mt} & \VAR{trial_quantity_mt} \\ \VAR{labels.loading_capacity} & \VAR{loading_capacity} \\ \VAR{labels.loading_port} & \VAR{loading_port} \\ \VAR{labels.destination_port} & \VAR{destination_port} \\ \VAR{labels.delivery_time} & \VAR{delivery_time} \\ \end{tabularx}
\end{center}
...
\begin{center}
\begin{tabularx}{\textwidth}{>{\columncolor{lightgray}\bfseries\raggedright\arraybackslash}p{6cm} >{\raggedright\arraybackslash}X}
\VAR{labels.quantity} & \VAR{contract_quantity} \\ \VAR{labels.price} & \VAR{contract_price} \\ \VAR{labels.monthly_shipment_value} & \VAR{monthly_shipment_value} \\ \VAR{labels.annual_contract_value} & \VAR{annual_contract_value} \\ \VAR{labels.contract_duration} & \VAR{contract_duration} \\ \VAR{labels.loading_capacity} & \VAR{contract_loading_capacity} \\ \VAR{labels.annual_contract_quantity} & \VAR{annual_contract_quantity} \\ \VAR{labels.loading_port} & \VAR{contract_loading_port} \\ \VAR{labels.destination_port} & \VAR{contract_destination_port} \\ \VAR{labels.delivery_time} & \VAR{contract_delivery_time} \\ \end{tabularx}
\end{center}
...
\multicolumn{1}{>{\columncolor{lightgray}\bfseries\raggedright\arraybackslash}p{5.5cm}}{\VAR{labels.category}} & \multicolumn{1}{>{\bfseries\raggedright\arraybackslash}X}{\VAR{labels.specification}} \\ \VAR{labels.product_name_label} & \VAR{product_name} \\ \VAR{labels.grade} & \VAR{spec_grade} \\ \VAR{labels.origin} & \VAR{spec_origin} \\ \VAR{labels.origin_cert} & \VAR{spec_certification} \\ \VAR{labels.processing} & \VAR{spec_processing} \\ \VAR{labels.appearance} & \VAR{spec_appearance} \\ \VAR{labels.odor} & \VAR{spec_odor} \\ \VAR{labels.bones} & \VAR{spec_bones} \\ \VAR{labels.blood_stains} & \VAR{spec_blood_stains} \\ \VAR{labels.moisture_content} & \VAR{spec_moisture} \\ \VAR{labels.damage} & \VAR{spec_damage} \\ \VAR{labels.chicken_paw_pad} & \VAR{spec_paw_pad} \\ \VAR{labels.weight_per_piece} & \VAR{spec_weight_per_piece} \\ \VAR{labels.length_per_piece} & \VAR{spec_length_per_piece} \\ \VAR{labels.packaging} & \VAR{spec_packaging} \\ \VAR{labels.inner_packing} & \VAR{spec_inner_packing} \\ \VAR{labels.carton_weight} & \VAR{spec_carton_weight} \\ \VAR{labels.freezing_temp} & \VAR{spec_freezing_temp} \\ \VAR{labels.storage_temp} & \VAR{spec_storage_temp} \\ \VAR{labels.transport_temp} & \VAR{spec_transport_temp} \\ \VAR{labels.freezing_process} & \VAR{spec_freezing_process} \\ \VAR{labels.shelf_life} & \VAR{spec_shelf_life} \\ \VAR{labels.packaging_note} & \VAR{spec_packaging_note} \\ \end{tabularx}
\end{center}
...
\VAR{labels.company_name} & \VAR{buyer_company} \\ \VAR{labels.address} & \VAR{buyer_address} \\ \VAR{labels.contact_person} & \VAR{buyer_contact_person} \\ \VAR{labels.email} & \VAR{buyer_email} \\ \VAR{labels.country} & \VAR{buyer_country} \\ \VAR{labels.phone_no} & \VAR{buyer_phone} \\ \end{tabularx}
\end{center}
...
\begin{center}
\begin{tabularx}{\textwidth}{>{\columncolor{lightgray}\bfseries\raggedright\arraybackslash}p{5cm} >{\raggedright\arraybackslash}X}
\VAR{labels.bank_name} & \VAR{buyer_bank_name} \\ \VAR{labels.bank_address} & \VAR{buyer_bank_address} \\ \VAR{labels.bank_swift_code} & \VAR{buyer_bank_swift} \\ \VAR{labels.account_name} & \VAR{buyer_account_name} \\ \VAR{labels.account_number} & \VAR{buyer_account_number} \\ \VAR{labels.bank_officer} & \VAR{buyer_bank_officer_email} \\ \end{tabularx}
\end{center}
...
\begin{center}
\begin{tabularx}{\textwidth}{>{\columncolor{lightgray}\bfseries\raggedright\arraybackslash}p{5.5cm} >{\raggedright\arraybackslash}X}
Trial Container & \VAR{trial_container} \\ Price & \VAR{trial_price} \\ Trial Shipment Value & \VAR{trial_shipment_value} \\ Trial Quantity in MT & \VAR{trial_quantity_mt} \\ Loading Capacity & \VAR{loading_capacity} \\ Loading Port & \VAR{loading_port} \\ Destination Port & \VAR{destination_port} \\ Delivery Time & \VAR{delivery_time} \\ \end{tabularx}
\end{center}
...
\begin{center}
\begin{tabularx}{\textwidth}{>{\columncolor{lightgray}\bfseries\raggedright\arraybackslash}p{5.5cm} >{\raggedright\arraybackslash}X}
Quantity & \VAR{contract_quantity} \\ Price & \VAR{contract_price} \\ Monthly Shipment Value & \VAR{monthly_shipment_value} \\ Annual Contract Value & \VAR{annual_contract_value} \\ Contract Duration & \VAR{contract_duration} \\ Loading Capacity & \VAR{contract_loading_capacity} \\ Annual Contract Quantity & \VAR{annual_contract_quantity} \\ Loading Port & \VAR{contract_loading_port} \\ Destination Port & \VAR{contract_destination_port} \\ Delivery Time & \VAR{contract_delivery_time} \\ \end{tabularx}
\end{center}
...
\begin{center}
\begin{tabularx}{\textwidth}{>{\columncolor{lightgray}\bfseries\raggedright\arraybackslash}p{5cm} >{\raggedright\arraybackslash}X}
\multicolumn{1}{>{\columncolor{lightgray}\bfseries\raggedright\arraybackslash}p{5cm}}{CATEGORY} & \multicolumn{1}{>{\bfseries\raggedright\arraybackslash}X}{SPECIFICATION} \\ Product Name & \VAR{product_name} \\ Grade & \VAR{spec_grade} \\ Origin & \VAR{spec_origin} \\ Origin / Certification & \VAR{spec_certification} \\ Processing & \VAR{spec_processing} \\ Appearance & \VAR{spec_appearance} \\ Odor & \VAR{spec_odor} \\ Bones & \VAR{spec_bones} \\ Blood / Blood Stains & \VAR{spec_blood_stains} \\ Moisture Content & \VAR{spec_moisture} \\ Damage & \VAR{spec_damage} \\ Chicken Paw Pad & \VAR{spec_paw_pad} \\ Weight per Piece & \VAR{spec_weight_per_piece} \\ Length per Piece & \VAR{spec_length_per_piece} \\ Packaging & \VAR{spec_packaging} \\ Inner Packing & \VAR{spec_inner_packing} \\ Carton Weight & \VAR{spec_carton_weight} \\ Freezing Temperature & \VAR{spec_freezing_temp} \\ Storage Temperature & \VAR{spec_storage_temp} \\ Transportation Temperature & \VAR{spec_transport_temp} \\ Freezing Process & \VAR{spec_freezing_process} \\ Shelf Life & \VAR{spec_shelf_life} \\ Packaging & \VAR{spec_packaging_note} \\ \end{tabularx}
\end{center}
...
Company Name & \VAR{buyer_company} \\ Address & \VAR{buyer_address} \\ Contact Person & \VAR{buyer_contact_person} \\ Email Address & \VAR{buyer_email} \\ Country & \VAR{buyer_country} \\ Phone No. & \VAR{buyer_phone} \\ \end{tabularx}
\end{center}
...
\begin{center}
\begin{tabularx}{\textwidth}{>{\columncolor{lightgray}\bfseries\raggedright\arraybackslash}p{4cm} >{\raggedright\arraybackslash}X}
Bank Name & \VAR{buyer_bank_name} \\ Bank Address & \VAR{buyer_bank_address} \\ Bank Swift Code & \VAR{buyer_bank_swift} \\ Account Name & \VAR{buyer_account_name} \\ Account Number & \VAR{buyer_account_number} \\ Bank Officer/Email & \VAR{buyer_bank_officer_email} \\ \end{tabularx}
\end{center}
